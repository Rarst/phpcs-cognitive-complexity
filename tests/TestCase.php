...
use PHP_CodeSniffer\Util\Common as CommonUtil;
use ReflectionClass;
...
/**
 * Takenfrom https://github.com/slevomat/coding-standard/blob/master/SlevomatCodingStandard/Sniffs/TestCase.php
 *
 *
 * @codeCoverageIgnore
 */
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
	...
	/**
	 * Customized / different from Slevomat
	 */
	private static function getSniffName(): string
	{
		return CommonUtil::getSniffCode(static::getSniffClassName());
	}
	...
	{
		$className = \substr(static::class, 0, -\strlen('Test'));
		return \preg_replace('#\\\Tests?\\\#i', '\\', $className);
	}
